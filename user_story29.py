...
def living_married(indi_list, fam_list):
    marriage_list = []
    for i in fam_list:
        if(death_date(indi_list, i[1]) == None):
            if(i[1] not in marriage_list):
                marriage_list.append(i[1])
        if(death_date(indi_list, i[2]) == None):
            if(i[2] not in marriage_list):
                marriage_list.append(i[2])
    print ("Individuals who are married and alive are: \n", marriage_list)
    for i in marriage_list:
        print("ID:" + i + " with name " + get_indi_name(indi_list, i) + " is married with family " + str(get_spouse_family(indi_list, i)))
